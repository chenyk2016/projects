...
(function(){
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            inputWidth = $G('upload_width').value,
            inputHeight = $G('upload_height').value,
            width = parseInt(isNumber(inputWidth) ? inputWidth : 420 , 10) || 420,
            height = parseInt(isNumber(inputHeight) ? inputHeight : 280, 10) || 280;
