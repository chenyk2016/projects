...
(function () {
        ...
        window.UEDITOR_CONFIG = {
            ...
            , toolbars: [[
                'simpleupload', 'insertvideo', 'bold', 'italic', 'underline', 'strikethrough', 'horizontal', '|',
                'forecolor', 'backcolor', '|',
                'paragraph', 'fontfamily', 'fontsize', 'lineheight', '|',
                'insertorderedlist', 'insertunorderedlist', '|',
                'removeformat', 'blockquote', 'link', 'attachment', '|',
            ...
            ,filterTxtRules : function() {
                function delDom(node) { // 如果是图片、视频、超链接、附件 直接删除
            ...
            ,'fontsize':[0.5,1,1.2,1.4,1.5,1.6,1.8, 2,2.1,2.2,2.3,2.4,2.5,2.6,2.8, 3,3.5, 4,4.5, 5,5.5, 6,6.5, 7,7.5, 8,8.5, 9]
            //paragraph
